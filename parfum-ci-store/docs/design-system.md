...
- Checkout and confirmation must display delivery fees as `À confirmer` when Phase 8 records zero pending manual confirmation. Do not style the pending fee as free delivery.
