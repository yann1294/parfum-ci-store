...
export type CatalogueAuditAction =
  ...
  | "STOREFRONT_HOME_CONTENT_UPDATED"
  | "STOREFRONT_ABOUT_CONTENT_UPDATED"
  | "STOREFRONT_CONTACT_CONTENT_UPDATED"
  | "STOREFRONT_DELIVERY_CONTENT_UPDATED"
  | "STOREFRONT_SOCIAL_CONTENT_UPDATED"
  | "STOREFRONT_PAYMENT_SETTINGS_UPDATED";
