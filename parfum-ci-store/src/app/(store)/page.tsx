    ...
    <PageContainer className="py-12 md:py-16">
      <section className="grid gap-10 md:grid-cols-[1.05fr_0.95fr] md:items-center">
        ...
        <div className="relative aspect-[4/5] overflow-hidden rounded-lg border bg-surface-muted">
          {featured[0] ? (
            <ProductCard product={featured[0]} priority />
          ) : (
      ...
      <section className="mt-16 grid gap-8">
        <SectionHeading as="h2" eyebrow="Sélection" title="Parfums mis en avant" />
        {featured.length > 0 ? (
          ...
          <EmptyState
            ...
            description="Les parfums mis en avant apparaîtront ici après publication."
          />
        )}
      </section>
      ...
      <section className="mt-16 grid gap-6 md:grid-cols-2">
        <SectionHeading as="h2" eyebrow="Commande" title="Comment commander" />
